...
/**
 * This class contains methods that interact with browser elements and
 * also some other methods that are usefull
 *
 * @author bsfraga
 */
public class Utils {
    ...
    public ArrayList<WebElement> getElementsWithMcGyver(By locator) {
        try {
            return (ArrayList<WebElement>) (ArrayList) getDriver().findElements(locator);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    /**
     * This method makes the driver move and focus to a specific element by clicking on it.
     * @param locator
     */
    public void moveToElementAndClick(By locator){
        try{
            ...
            e.printStackTrace();
            logFail("Não foi possível mover o mouse até o elemento e clicar.");
        }
    }
    ...
    public void goToUrl(String url) {
        try {
            ...
            Report.logPass("URL acessada. URL: " + url, ScreenshotManager.capture(getDriver()));
        } catch (Exception e) {
    ...
    public void sendKeys(By locator, String text) {
        try {
            ...
            Report.logPass("Texto inserido. Texto: " + text, ScreenshotManager.capture(getDriver()));
        } catch (Exception e) {
    ...
    public void clickButton(By locator) {
        try {
            getDriver().findElement(locator).click();
            Report.logPass("Click efetuado. Locator: " + locator, ScreenshotManager.capture(getDriver()));
        } catch (Exception e) {
