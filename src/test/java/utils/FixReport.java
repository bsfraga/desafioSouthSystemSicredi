...
public class FixReport {
    ...
    public static void fixReport(){
        try {
            ...
            BufferedReader bufferedReader = new BufferedReader(new FileReader("reports\\Report.html"));
            ...
            BufferedWriter bufferedWriter = new BufferedWriter(new FileWriter("reports\\Report.html"));
